...
import {InputNumber,Button,Icon,Row,Col,message,Spin} from "antd";
import HoverAnimation from "../../Animations/HoverAnimation"

import Stars from "../../Components/Stars"
import ProductData from "../../Data/ExampleData/ProductData";
import {odmianaOpinii,odmianaSztuk} from "../../Utilities/Odmiana"

function Overall(props){

    let {productData,center,availabilityInfo} = props;
    ...
    function inputNumberHandler(number){
        if(!(number>availabilityInfo.count)) {
            ...
            message.error(`W magazynie znajduje się jedynie ${availabilityInfo.count} ${odmianaSztuk(availabilityInfo.count)}`)
        }
    }
    ...
    return(
        <div style={containerStyle}>
            ...
            <div style={priceDivStyle} ><span style={colorSpan}>{productData.price}zł</span>
